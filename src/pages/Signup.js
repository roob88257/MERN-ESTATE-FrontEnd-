...
function Signup() {
   ...
   const formSubmitHandler=(e)=>{
    ...
    axios.post('http://localhost:5000/api/auth/signup', formInput , {
        headers: {
 ...
 // window.location.reload()
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
        ...
        <input onChange={formChangeHandler} type="text" name="username" placeholder="Username" className='border p-3 rounded-lg focus:outline-slate-300'/>
        ...
        <button type="submit" disabled={isLoading} className='bg-[#334155] p-3 rounded-md text-white hover:bg-slate-600 disabled:opacity-80'>{isLoading ? 'isLoading...' : 'SIGN UP' }</button>
        <Toaster/>    
        </form> 
